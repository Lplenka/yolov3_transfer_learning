...
def main(_):
  ...
  train_output_path = os.path.join(FLAGS.output_dir, 'd2s_train.record')
  val_output_path = os.path.join(FLAGS.output_dir, 'd2s_val.record')
  testdev_output_path = os.path.join(FLAGS.output_dir, 'd2s_testdev.record')
